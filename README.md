...
5. **등록된 시간 자동 알람**:
   - 일정에 등록된 시간(예: `09:00`)이 되면 단테 삐삐 비프음과 진동, 상단 알람 배너가 자동으로 동작
   - Android 네이티브 AlarmManager 및 시스템 알림(Notification) 지원
   - 기본 활성화(`default: ON`)되며, 환경 설정의 [화면 / 사운드 / 알람] 탭에서 자유롭게 토글 가능
